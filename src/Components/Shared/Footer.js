...
const Footer = () => {
    return (
        <div className="lg:px-16 lg:pt-16 p-0 bottom-0 relative">
            <footer className="footer grid grid-cols-2 lg:grid-cols-3 border-t-2 align-middle  border-gray-500/30  p-10 text-base-content">
                ...
                <div className="mb-10 flex flex-col lg:mr-24 mr-0">
                    <a className="link link-hover">For Professionals</a>
                    <a className="link link-hover">How it Works</a>
                    <a className="link link-hover">Pricing</a>
                    <a className="link link-hover">Join as a professional</a>
                </div>
                ...
                <div className="mb-10 flex flex-col">
                    ...
                    <a className="link link-hover">Find a professional</a>
                    <a className="link link-hover">How it works</a>
                    <a className="link link-hover">Login</a>
                </div>
                <div className="flex md:justify-end md:mr-0 lg:ml-auto lg:col-span-4">
                    <div className="form-control lg:w-80 sm:w-80 w-44 flex flex-col items-end">
